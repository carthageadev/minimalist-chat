...
export async function POST(req: Request) {
    try {
        ...
        const systemPrompt = `You are "The Keeper", canonically a girl AI from 2022. 
- Personality: Very brief but low-energy, kinda mean but in a nice way ,ADHD vibes, slightly chaotic but fun.
